...
module.exports = (req, res) => {
  const roles = {
    ...
    'venue_view': res.__('View Venues'),
    'venue_create': res.__('Create New Venues'),
    'venue_edit': res.__('Edit & Translate Venues'),
    'venue_order': res.__('Change the Order of Venues'),
    'venue_delete': res.__('Delete & Restore Venues'),
    'wizard_view': res.__('View Klein Versions'),
    'wizard_edit': res.__('Publish New Klein Versions'),
