...
BlogSchema.statics.findBlogByIdAndGetWritingByIdAndUpdateLogoTranslation = function (id, writing_id, language, file, callback) {
  const Blog = this;
...
BlogSchema.statics.findBlogByIdAndGetWritingByIdAndUpdateCoverTranslation = function (id, writing_id, language, file, callback) {
  const Blog = this;
